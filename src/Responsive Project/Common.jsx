            ...
            <div className="col-10 mx-auto">
               <div className="row">
                 <div className="col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex justify-contect-center flex-column" >
                  <h1>{name} <strong className='brand-name'> Hariom Dhakad</strong></h1>
                  <h2 className='my-3'>
                    We are the team of talented developer making websited
                  </h2>
                  <div className="mt-3">
                    <NavLink 
                    to={visit} className='btn-get-started'>{btname}
                    </NavLink>
                  </div>
                 </div>
